...
import { getMockQuoteTickerSymbol, getMockQuoteTicker } from 'features/quoteTable/utils';
...
describe('Test ticker queue', () => {
  it('Default use', async () => {
    ...
    (getInitialTickers as jest.MockedFunction<typeof getInitialTickers>).mockResolvedValueOnce(testInitMapTicker);
    ...
    expect(dispatch).toHaveBeenNthCalledWith(2, tickersSlice.actions.tickers.set(testInitMapTicker));
